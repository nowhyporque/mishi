...
// // // // // // const Maps = () => {
// // // // // //   const [activeTab, setActiveTab] = useState('cats'); // 'cats' or 'helpers'
...
// // // // // //     } else if (activeTab === 'helpers' && showHelperForm) {
// // // // // //       // User is placing their helper zone
// // // // // //     }
// // // // // //   };
...
// // // // // //         lat: myHelperZone.location.lat,
// // // // // //         lng: myHelperZone.location.lng
// // // // // //       });
// // // // // //       setHelperFormData({
// // // // // //         radius: myHelperZone.radius,
// // // // // //         helpOffered: myHelperZone.helpOffered,
// // // // // //         availability: myHelperZone.availability || ''
// // // // // //       });
// // // // // //     } else {
// // // // // //       // Add new zone
// // // // // //       setNewMarkerPosition(null);
...
// // // // // //   // Get pin color based on type and SOS status
// // // // // //   const getPinColor = (type, isSOS) => {
// // // // // //     if (isSOS) return '#DC143C'; // RED for SOS
    
// // // // // //     switch(type) {
// // // // // //       case 'stray': return '#0000FF'; // BLUE
// // // // // //       case 'colony': return '#00FF00'; // GREEN
// // // // // //       case 'kitten': return '#FFA500'; // ORANGE
// // // // // //       default: return '#DC143C'; // RED fallback
// // // // // //     }
// // // // // //   };
...
// // // // // //       {/* Add Helper Zone Button (only visible on helpers tab) */}
// // // // // //       {activeTab === 'helpers' && (
// // // // // //         <div style={{
// // // // // //           position: 'absolute',
// // // // // //           top: '70px',
...
// // // // // //       >
// // // // // //         {/* Cat Sightings */}
// // // // // //         {activeTab === 'cats' && markers.map((marker) => {
...
// // // // // //        {/* Helper Zones - ONLY show when NOT in add/edit mode */}
// // // // // // {activeTab === 'helpers' && !showHelperForm && helperZones.map((zone) => {
...
// // // // // //         {/* Temporary cat marker while placing */}
// // // // // //         {activeTab === 'cats' && newMarkerPosition && showCatForm && (() => {
...
// // // // // //         {/* Temporary helper zone while placing */}
// // // // // //         {activeTab === 'helpers' && newMarkerPosition && showHelperForm && (
// // // // // //           <Circle
...
// // // // // //       {activeTab === 'helpers' && !showHelperForm && (
// // // // // //         <div style={{
// // // // // //           position: 'absolute',
// // // // // //           bottom: '20px',
// // // // // //           left: '50%',
...
// // // // // //       {activeTab === 'helpers' && showHelperForm && !newMarkerPosition && (
// // // // // //         <div style={{
// // // // // //           position: 'absolute',
// // // // // //           bottom: '20px',
// // // // // //           left: '50%',
...
// // // // //       {/* Main Map - Shows everything when not adding helper zone */}
// // // // //       {(!showHelperForm || activeTab === 'cats') && (
// // // // //         <GoogleMap
// // // // //           key="main-map"
// // // // //           mapContainerStyle={{ width: '100%', height: '100%' }}
// // // // //           center={mapRef.current ? undefined : center}
...
// // // // //           {/* Helper Zones */}
// // // // //           {activeTab === 'helpers' && helperZones.map((zone) => {
// // // // //             const isMyZone = auth.currentUser && zone.userId === auth.currentUser.uid;
...
// // // // //       {/* Clean Map - For adding helper zone only */}
// // // // //       {showHelperForm && activeTab === 'helpers' && (
// // // // //         <GoogleMap
// // // // //           key="helper-map"
// // // // //           mapContainerStyle={{ width: '100%', height: '100%' }}
// // // // //           center={center}
...
// // // // //           onClick={handleMapClick}
// // // // //         >
// // // // //           {/* Only show temporary zone being placed */}
// // // // //           {newMarkerPosition && (
// // // // //             <Circle
// // // // //               center={newMarkerPosition}
// // // // //               radius={milesToMeters(helperFormData.radius)}
...
// // // //       {/* ONE MAP - Position preserved throughout */}
// // // //       <GoogleMap
// // // //         mapContainerStyle={{ width: '100%', height: '100%' }}
// // // //         center={mapRef.current ? undefined : center}
// // // //         zoom={12}
...
// // // //         onLoad={onLoad}
// // // //       >
// // // //         {/* Cat Sightings - ONLY show when on cats tab AND not in helper form */}
// // // //         {activeTab === 'cats' && !showHelperForm && markers.map((marker) => {
// // // //           const isMyReport = auth.currentUser && marker.reportedBy === auth.currentUser.uid;
// // // //           const pinColor = getPinColor(marker.type, marker.isSOS);
// // // //           const centerColor = isMyReport ? '#FFD700' : '#FFFFFF';
...
// // // //         {/* Helper Zones - ONLY show when on helpers tab AND not in helper form */}
// // // //         {activeTab === 'helpers' && !showHelperForm && helperZones.map((zone) => {
// // // //           const isMyZone = auth.currentUser && zone.userId === auth.currentUser.uid;
...
// // //           onClick={() => {
// // //             setActiveTab('cats');
// // //             setShowHelperForm(false); // Clear helper form when switching
...
// // //             setShowCatForm(false); // Clear cat form when switching
...
// // //       {/* ONE MAP - Key forces re-render to clear caches */}
// // //      <GoogleMap
// // //   mapContainerStyle={{ width: '100%', height: '100%' }}
// // //   center={mapRef.current ? undefined : center}
// // //   zoom={12}
...
// // //   onLoad={onLoad}
// // // >
// // //         {/* Cat Sightings - ONLY on cats tab, NOT in helper form */}
// // //         {activeTab === 'cats' && !showHelperForm && markers.map((marker) => {
// // //           const isMyReport = auth.currentUser && marker.reportedBy === auth.currentUser.uid;
// // //           const pinColor = getPinColor(marker.type, marker.isSOS);
// // //           const centerColor = isMyReport ? '#FFD700' : '#FFFFFF';
...
// // //         {/* Helper Zones - ONLY on helpers tab, NOT in helper form */}
// // //         {activeTab === 'helpers' && !showHelperForm && helperZones.map((zone) => {
// // //           const isMyZone = auth.currentUser && zone.userId === auth.currentUser.uid;
...
// //         {/* HELPER ZONES - Show ONLY on helpers tab AND when NOT editing */}
// //         {activeTab === 'helpers' && !showHelperForm && helperZones.map((zone) => {
// //           const isMyZone = auth.currentUser && zone.userId === auth.currentUser.uid;
...
// //         {/* Temporary helper zone - ONLY show when editing */}
// //         {activeTab === 'helpers' && showHelperForm && newMarkerPosition && (
// //           <Circle
// //             center={newMarkerPosition}
// //             radius={milesToMeters(helperFormData.radius)}
...
//           // Map stays at default NYC location
//         }
//       );
//     }
//   };
